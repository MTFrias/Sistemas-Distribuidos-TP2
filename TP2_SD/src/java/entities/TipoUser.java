...
@NamedQueries({
    ...
    @NamedQuery(name = "TipoUser.findByTipo", query = "SELECT t FROM TipoUser t WHERE t.tipo = :tipo")})
public class TipoUser implements Serializable {
    ...
    public TipoUser(Integer idTipo, String tipo) {
        this.idTipo = idTipo;
        this.tipo = tipo;
    }
    ...
    public String toString() {
        return "entities.TipoUser[ idTipo=" + idTipo + " ]";
    }
